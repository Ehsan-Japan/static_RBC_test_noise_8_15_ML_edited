...
class DQDSimulator:
    ...
    def _run_double_dot(self) -> None:
        ...
        # double_dot_data.npy keeps only WHETHER the charge state changes; the
        # acceptance test in dqd_validator.py needs to know HOW it changes, to
        # tell an interdot transition (charge moves between the dots at fixed
        # total charge — the double-dot signature) from a lead transition.
